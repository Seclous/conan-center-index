...
class HDiffPatchConan(ConanFile):
    ...
    test_package_folder = "test/conan"
    ...
    options = {
        ...
        "enable_msvc_static_runtime": [True, False],
    ...
    default_options = {
        ...
        "enable_msvc_static_runtime": False,
        "enable_bzip2": True,
    ...
    def generate(self):
        ...
        tc.variables["HDIFFPATCH_ENABLE_LOGGING"] = self.options.enable_logging
        tc.variables["HDIFFPATCH_MSVC_STATIC_RUNTIME"] = self.options.enable_msvc_static_runtime
