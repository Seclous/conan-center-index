...
class ConanXqilla(ConanFile):
    ...
    def validate(self):
        ...
        if os_ not in ["Linux", "FreeBSD", "Macos", "Windows"]:
    ...
    def generate(self):
        ...
        # Upstream makefiles respect CXXFLAGS/LDFLAGS
        tc.extra_cxxflags = ["-std=c++11"]
        # pthread needed on POSIX; MinGW’s pthreads is provided by the toolchain
